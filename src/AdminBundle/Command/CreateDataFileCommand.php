...
class CreateDataFileCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        //En este punto es donde me doy cuenta que la generacion de rutas es solo par una empresa
        if(count($proceso)>0)
        {
            ...
            //Lista de clientes
            $clientes = $manager->getRepository("AppBundle:Cliente")->buscarCamionesDeLaEmpresa($empresa);
