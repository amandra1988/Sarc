...
class CreateRouteCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($fs->exists($absolutePath."data/".$nfile.".sol"))
        {
            ...
            //$cantClientes = $proceso->getPrcCantidadClientes();
            ...
            while(!feof($file)){
                ...
                { 
                   ...
                   $desde = ($l+1);
                   $hasta = ($desde + $configAmpl[0]->getDias());  
                        ...
                        if(in_array(1, $datos)):
                            ...
                            for($d=1;$d<=20;$d++):
                                ...
                                if($datos[$d]):
                                    ...
                                    //$titulo= 'Ruta de trabajo operador - '.$camion->getOperador()->getId();
                                    
                                    $titulo= 'Ruta de trabajo '.date('d/m/Y',$fechas[$d]) .' [OP:'.$camion->getOperador()->getId().']';  
